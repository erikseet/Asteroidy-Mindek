...
class Asteroid(SpaceObject):
    def tick(self, dt):
        self.x_speed = self.x_speed + dt * ACCELERATION * math.cos(self.rotation - random.randint(0, 69))
        self.y_speed = self.y_speed + dt * ACCELERATION * math.sin(self.rotation - random.randint(0, 69))
...
class Game:
    ...
    def load_resources(self):
        ...
        self.asteroid_grey_tiny = pyglet.image.load('Assetss/PNG/Meteors/meteorGrey_tiny2.png')
        self.asteroid_grey_med = pyglet.image.load('Assetss/PNG/Meteors/meteorGrey_med1.png')
        self.asteroid_grey_big = pyglet.image.load('Assetss/PNG/Meteors/meteorGrey_big3.png')
        self.asteroid_grey_small = pyglet.image.load('Assetss/PNG/Meteors/meteorGrey_small2.png')
        self.asteroid_grey_big2 = pyglet.image.load('Assetss/PNG/Meteors/meteorGrey_big2.png')
    ...
    def create_asteroids(self, count):
        for i in range(count): #count per asteroid
            self.create_asteroid(self.asteroid_grey_big)
            self.create_asteroid(self.asteroid_grey_big2)
            self.create_asteroid(self.asteroid_grey_med)
            self.create_asteroid(self.asteroid_grey_small)
